...
import { CreateParticpantRequestDto } from './dto/request/create-participant-request.dto';
import { GetParticipantResponseDto } from './dto/response/get-particpant-response.dto';
...
export class ParticipantController {
  ...
  async getParticipantsByCampaign(@Param('campaignId') campaignId: string): Promise<Array<GetParticipantResponseDto>> {
  ...
  async getParticipantByUser(@Param('userId') userId: string) {
      return this.participantService.getParticipantsByUser(Number(userId));
  }
